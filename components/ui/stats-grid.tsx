...
import { getResponsiveGridClass, getSmartGridClass } from '@/lib/responsive-grid-system'
...
export function StatsGrid({
  ...
  // Use smart grid system based on actual item count and desired columns
  // Allow more columns for better screen utilization
  const maxColumns = Math.max(columns, 8) // Allow up to 8 columns on ultra-wide
  const gridClass = getSmartGridClass(items.length, maxColumns)
