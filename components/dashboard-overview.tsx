...
import { Calendar, Clock, Users, AlertCircle, Plus, Sparkles, TrendingUp, MapPin, DollarSign, Target, Trophy, Star, Activity } from 'lucide-react'
...
export function DashboardOverview() {
  ...
  return (
    <PageLayout>
      ...
      {/* Main Content Grid */}
      <div className={getSmartGridClass(refereePerformance ? 3 : 2, 6) + ' gap-6'}>
                ...
                {upcomingGames.map((game) => {
                  ...
                  return (
                    <div key={game.id} className="p-4 border rounded-lg space-y-3">
                      ...
                      {/* Game Details */}
                      <div className={getResponsiveGridClass('forms', 'complex') + ' text-sm'}>
                        <div className="flex items-center">
