...
class MetricsCollector {
  ...
  startCollection() {
    ...
    this.registerCollector('performance', () => {
      import { getPerformanceStats  } from '../middleware/performanceMonitor';
      return getPerformanceStats();
    });
    
    this.registerCollector('advanced', () => {
      import { getAdvancedMetrics  } from '../middleware/advanced-performance';
      return getAdvancedMetrics();
    });
    
    this.registerCollector('database', () => {
      import { getQueryPerformanceStats  } from './query-performance';
