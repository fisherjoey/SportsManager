 ...
 *
 * Seeds sample locations (sports venues/gyms) for game assignments.
 * This includes 10 realistic Calgary-area facilities with complete information.
 *
 * For a full CMBA location list (113 locations), see the archived file:
 * backend/seeds/_archive/001_locations.js
 *
 * This seed CLEARS existing locations - not fully idempotent.
 */

exports.seed = async function(knex) {
  console.log('🏟️  Seeding sample locations...\n');
  ...
  // ============================================================================
  // Define sample locations (sports facilities in Calgary area)
  // ============================================================================
  const locations = [
    {
      name: 'Genesis Centre',
  ...
  console.log('Summary:');
  console.log(`  - ${locations.length} locations created in Calgary area`);
  console.log('  - All locations have complete facility information');
  console.log('  - All locations are wheelchair accessible');
  console.log();
};
