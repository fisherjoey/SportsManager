...
exports.up = async function(knex) {
  ...
  // 3. Create mentorship_assignments table
  ...
  // 4. Create mentee_profiles table
  ...
  console.log('✓ Created mentorship tables: mentees, mentors, mentorship_assignments, mentee_profiles');
};
