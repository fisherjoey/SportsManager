...
describe('LocationWithDistance', () => {
  ...
  beforeEach(() => {
    ...
    mockBuildFullAddress.mockImplementation(
  ...
  describe('basic rendering', () => {
    ...
    it('should render with address details', () => {
      ...
      expect(
        screen.getByText('555 Saddledome Rise SE, Calgary, AB, T2G 2W1')
      ).toBeInTheDocument();
    });
  ...
  describe('distance functionality', () => {
    ...
    it('should disable distance when showDistance is false', () => {
      ...
      expect(mockUseDistance).toHaveBeenCalledWith('Calgary Saddledome', {
        enabled: false,
  ...
  describe('compact mode', () => {
    it('should render in compact mode', () => {
      render(
        <LocationWithDistance location="Calgary Saddledome" compact={true} />
      );
  ...
  describe('map link functionality', () => {
    it('should open Google Maps when map link is clicked', () => {
      mockGenerateGoogleMapsURL.mockReturnValue(
      ...
      expect(mockGenerateGoogleMapsURL).toHaveBeenCalledWith(
        'Calgary Saddledome'
      );
  ...
  describe('styling and accessibility', () => {
    ...
    it('should render map pin icon', () => {
      ...
      const mapIcon = document.querySelector(
        '[data-testid="map-pin"], .lucide-map-pin'
      );
  ...
  describe('edge cases', () => {
    it('should handle missing city gracefully', () => {
      render(
        <LocationWithDistance location="Venue Name" address="123 Street" />
      );
    ...
    it('should handle very long location names in compact mode', () => {
      const longName =
        'Very Long Location Name That Should Be Truncated In Compact Mode';

      render(<LocationWithDistance location={longName} compact={true} />);
    ...
    it('should maintain loading state properly', () => {
      ...
      expect(screen.getByText('Calculating...')).toBeInTheDocument();
      expect(
        screen.queryByText('Distance unavailable')
